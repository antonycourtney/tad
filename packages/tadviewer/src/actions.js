...
export const initAppState = (
  ...
  return aggtree.getBaseSchema(rtc, baseQuery).then(baseSchema => {
...
const vpUpdate = (f: (vp: ViewParams) => ViewParams) => (s: AppState) =>
  s.updateIn(["viewState", "viewParams"], f);
...
export const toggleAllShown = (updater: RefUpdater): void => {
  updater(s => {
    ...
    return vpUpdate(viewParams =>
      viewParams.set("displayColumns", nextDisplayColumns)
    )(s);
  });
};
...
export const toggleShowRoot = (updater: RefUpdater): void => {
  updater(
    vpUpdate(viewParams => viewParams.set("showRoot", !viewParams.showRoot))
  );
};
...
export const setColumnOrder = (
  ...
  updater(
    vpUpdate(viewParams => viewParams.set("displayColumns", displayColumns))
  );
};
...
export const updateViewport = (
  ...
  updater(st =>
    st.update("viewState", vs =>
      vs.set("viewportTop", top).set("viewportBottom", bottom)
    )
  );
};
...
export const setDefaultFormatOptions = (
  ...
  updater(
    vpUpdate(viewParams => viewParams.setIn(["defaultFormats", colType], opts))
  );
};
...
export const setExportDialogOpen = (
  ...
  updater(s =>
    s.set("exportDialogOpen", openState).set("exportFilename", saveFilename)
  );
};
